...
Revision ID: e3c452322cbc
Revises: 
Create Date: 2025-09-17 11:05:52.264607
...
def upgrade() -> None:
    ...
    op.create_table('backlog_cards',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('title', sa.String(length=200), nullable=False),
    sa.Column('location', sa.String(length=200), nullable=False),
    sa.Column('distance_from_hotel_km', sa.Numeric(precision=10, scale=2), nullable=True),
    sa.Column('cost', sa.Numeric(precision=10, scale=2), nullable=True),
    sa.Column('rating', sa.Numeric(precision=3, scale=1), nullable=True),
    sa.Column('desire_to_go', sa.Numeric(precision=3, scale=1), nullable=True),
